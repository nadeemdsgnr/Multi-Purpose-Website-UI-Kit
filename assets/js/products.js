    ...
    columns: [
        ...
        }, 
        {
            ...
            formatter: function(e, t) {
                ...
                return gridjs.html('<div class="dropdown"><button class="btn btn-primary btn-sm dropdown" type="button" data-bs-toggle="dropdown" aria-expanded="false"><i class="bx bx-dots-horizontal-rounded"></i></button><ul class="dropdown-menu dropdown-menu-end fs-s"><li><a class="dropdown-item d-flex align-items-center" href="#"><i class="bx bxs-show align-bottom me-2 text-muted"></i> View</a></li><li><a class="dropdown-item d-flex align-items-center edit-list" data-edit-id=' + t + ' href="#"><i class="bx bxs-pencil align-bottom me-2 text-muted"></i> Edit</a></li><li class="dropdown-divider"></li><li><a class="dropdown-item d-flex align-items-center remove-list" href="#" data-id=' + t + ' data-bs-toggle="modal" data-bs-target="#removeItemModal"><i class="bx bxs-trash align-bottom me-2 text-muted"></i> Delete</a></li></ul></div>')
            }
    }],
    className: {
        table: "w-100",
